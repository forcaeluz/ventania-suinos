/**
 * Created by forcaeluz on 5/31/17.
 */

$(document).ready(function () {

    $('.tree').on('hide.bs.collapse', function () {
        $(this).parent().children('label').find('span.glyphicon').toggleClass('glyphicon-plus').toggleClass('glyphicon-minus');
    });
    $('.tree').on('show.bs.collapse', function () {
        $(this).parent().children('label').find('span.glyphicon').toggleClass('glyphicon-plus').toggleClass('glyphicon-minus');
    });
